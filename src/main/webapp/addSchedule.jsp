        ...
        <form method="post">
            ...
            <div class="schedules-content">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="name" id="planName" placeholder="Nazwa planu" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                                <textarea class="form-control" rows="5" id="planDescription" name="plan_description"
                                          placeholder="Opis plany" required></textarea>
                    </div>
                </div>
            </div>
        </form>
